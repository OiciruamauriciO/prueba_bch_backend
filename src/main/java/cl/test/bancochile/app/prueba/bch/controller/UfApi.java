...
public interface UfApi {
    ...
    /**
     * GET /v1/indicadores/tipo/uf : Get para indicador UF
     *
     ...
     */
	/*
    @ApiOperation(value = "Get para indicador UF", nickname = "uf", notes = "", response = RetornoJson.class, tags={ "uf", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = RetornoJson.class),
        @ApiResponse(code = 400, message = "(Bad Request) Los datos enviados son incorrectos o hay datos obligatorios no enviados", response = ErrorGenerico.class),
        @ApiResponse(code = 401, message = "(Unauthorized) No Autorizado", response = ErrorGenerico.class),
        @ApiResponse(code = 404, message = "(NotFound) No se encontro informacion", response = ErrorGenerico.class),
        @ApiResponse(code = 500, message = "Error en servidor", response = ErrorGenerico.class) })
    */
	@Operation(summary = "Get para indicador UF", description = "Indicador UF")
    ...
    @RequestMapping(
        ...
        value = "/v1/indicadores/tipo/{tipo}",
        produces = { "application/json" }
    )
    ResponseEntity<RetornoJson> uf(@PathVariable("tipo") String tipo);
